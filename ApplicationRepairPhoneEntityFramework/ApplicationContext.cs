...
namespace ApplicationRepairPhoneEntityFramework
{
    public class ApplicationContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Employee>().HasData(new Employee { ID_Employee = "Alex", Password = "231203", 
                FIO = "Савенков Александр Александров", ID_Position = 5, Series_Number_Password = "0000 000000", Address = "Воронеж", 
